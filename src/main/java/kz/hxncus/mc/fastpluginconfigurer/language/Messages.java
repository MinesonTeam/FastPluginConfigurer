...
public enum Messages {
    ...
    KEY, MENU_NOT_FOUND, MUST_BE_PLAYER, MUST_LOOKING_AT_DOUBLE_CHEST, NEXT_PAGE, PATH, PLAYER_LOGGED_WITH_CUSTOM_ITEM, PLUGIN_DOES_NOT_EXIST, PREFIX,
    PREVIOUS_PAGE, SECTION, SHIFT_CLICK_TO_COPY_CURRENT_VALUE, SHIFT_CLICK_TO_EDIT_SECTION, SOMEONE_DROPPED_CUSTOM_ITEM, SOMEONE_PICKED_CUSTOM_ITEM,
    SUCCESSFULLY_STORED_ITEMS_TO_CHEST, UNKNOWN_LANGUAGE, VALUE, VALUE_TOO_LONG, WRITE_NEW_KEY_IN_CHAT, WRITE_VALUE_IN_CHAT;
